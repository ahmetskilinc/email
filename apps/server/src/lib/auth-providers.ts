...
export const authProviders = (env: Record<string, string>): ProviderConfig[] => [
  ...
  },
  {
    ...
    envVarInfo: [
      { name: 'MICROSOFT_CLIENT_ID', source: 'Azure App Registration > Application (client) ID' },
      { name: 'MICROSOFT_CLIENT_SECRET', source: 'Azure App Registration > Certificates & secrets' },
    ],
    config: {

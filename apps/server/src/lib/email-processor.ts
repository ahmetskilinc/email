// @ts-expect-error - CssSanitizer is not typed
import CssSanitizerPkg from '@barkleapp/css-sanitizer';
const CssSanitizer = CssSanitizerPkg.CssSanitizer ?? CssSanitizerPkg;
